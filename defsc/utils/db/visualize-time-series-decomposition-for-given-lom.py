...
series = Series(
    time_series(extract_timestamp_from_airly_measurement, extract_pressure_from_airly_measurement, airly_measurements,
                lom_id))
series.plot()
...
series = Series(
    time_series(extract_timestamp_from_airly_measurement, extract_humidity_from_airly_measurement, airly_measurements,
                lom_id))
series.plot()
...
series = Series(
    time_series(extract_timestamp_from_mongo_id, extract_pressure_from_ow_measurement, ow_weather_measurements, lom_id))
series.plot()
...
series = Series(
    time_series(extract_timestamp_from_mongo_id, extract_humidity_from_ow_measurement, ow_weather_measurements, lom_id))
series.plot()
...
series = Series(
    time_series(extract_timestamp_from_mongo_id, extract_wind_deg_from_ow_measurement, ow_weather_measurements, lom_id))
series.plot()
...
series = Series(
    time_series(extract_timestamp_from_mongo_id, extract_wind_kph_from_wunder_measurement, wunder_weather_measurements,
...
series = Series(
    time_series(extract_timestamp_from_mongo_id, extract_temp_c_from_wunder_measurement, wunder_weather_measurements,
                nearest_wunder_sensors[lom_id]))
series.plot()
...
series = Series(
    time_series(extract_timestamp_from_mongo_id, extract_windchill_from_wunder_measurement, wunder_weather_measurements,
                nearest_wunder_sensors[lom_id]))
series = series.astype(float)
series.plot()
