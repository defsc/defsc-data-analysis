...
if __name__ == "__main__":
    ...
    for filename in os.listdir(directory):
        ...
        x_history_column_names = ['airly-pm10','ow-wnd-spd', 'ow-tmp', 'ow-hum']
        ...
        end_index = df.values.shape[0] - train_period - number_of_timestep_backward - number_of_timestep_ahead - test_period
        step = int(end_index / number_of_models)
        block_length = number_of_timestep_backward + train_period + number_of_timestep_backward + test_period + number_of_timestep_ahead
        ...
        for i in range(number_of_models):
            ...
            number_of_train_rows = number_of_rows - test_period
